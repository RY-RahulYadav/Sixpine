...
const SellerFilterOptions: React.FC = () => {
  ...
  const fetchDiscounts = async () => {
    try {
      const response = await (api as any).getDiscounts();
  ...
  const handleCategorySubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingCategory) {
        await (api as any).updateCategory(editingCategory.id, categoryForm);
        showToast('Category updated successfully', 'success');
      } else {
        await (api as any).createCategory(categoryForm);
  ...
  const handleSubcategorySubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingSubcategory) {
        await (api as any).updateSubcategory(editingSubcategory.id, subcategoryForm);
        showToast('Subcategory updated successfully', 'success');
      } else {
        await (api as any).createSubcategory(subcategoryForm);
  ...
  const handleColorSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingColor) {
        await (api as any).updateColor(editingColor.id, colorForm);
        showToast('Color updated successfully', 'success');
      } else {
        await (api as any).createColor(colorForm);
  ...
  const handleDeleteColor = async (id: number) => {
    ...
    try {
      await (api as any).deleteColor(id);
  ...
  const handleMaterialSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingMaterial) {
        await (api as any).updateMaterial(editingMaterial.id, materialForm);
        showToast('Material updated successfully', 'success');
      } else {
        await (api as any).createMaterial(materialForm);
  ...
  const handleDeleteMaterial = async (id: number) => {
    ...
    try {
      await (api as any).deleteMaterial(id);
  ...
  const handleDiscountSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingDiscount) {
        await (api as any).updateDiscount(editingDiscount.id, discountForm);
        showToast('Discount filter option updated successfully', 'success');
      } else {
        await (api as any).createDiscount(discountForm);
  ...
  const handleDeleteDiscount = async (id: number) => {
    ...
    try {
      await (api as any).deleteDiscount(id);
...
export default SellerFilterOptions;
