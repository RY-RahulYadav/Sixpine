...
const SellerOrderDetail: React.FC = () => {
  ...
  const handlePaymentStatusChange = async (paymentStatus: string) => {
    ...
    try {
      ...
      // Sellers cannot update payment status, only order status
      showToast('Payment status can only be updated by admin', 'error');
    ...
    <div className="admin-order-detail-improved">
      ...
      <div className="order-detail-grid">
        ...
        <div className="order-main-content">
                          ...
                          <div className="product-info-cell">
                            ...
                            <div className="product-details">
                              ...
                              {item.product?.id && (
                                  ...
                                  onClick={() => navigate(`${basePath}/products/${item.product.id}`)}
                                  >
                                    View Product
                                  </button>
                              )}
          ...
          {/* Payment Status Card - Read-only for sellers */}
          {!isSellerPanel && (
            <div className="order-card">
              <div className="card-header">
                <h3>
