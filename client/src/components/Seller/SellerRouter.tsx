...
import SellerFilterOptions from './FilterOptions/SellerFilterOptions';
import SellerCoupons from './Coupons/SellerCoupons';
import SellerBrandAnalytics from './Analytics/SellerBrandAnalytics';
import SellerShipmentSettings from './Settings/SellerShipmentSettings';
  ...
  return (
    <Routes>
      <Route element={<SellerLayout />}>
        ...
        <Route path="filter-options" element={<SellerFilterOptions />} />
        <Route path="coupons" element={<SellerCoupons />} />
        <Route path="analytics/brand" element={<SellerBrandAnalytics />} />
        <Route path="shipment-settings" element={<SellerShipmentSettings />} />
