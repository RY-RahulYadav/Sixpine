...
from admin_api.serializers import (
    AdminCategorySerializer, AdminSubcategorySerializer, AdminColorSerializer,
    AdminMaterialSerializer, AdminProductListSerializer, AdminProductDetailSerializer,
...
def seller_dashboard_stats(request):
    ...
    # Calculate total revenue: sum of (price * quantity) for all order items
...
# ==================== Category Management Views (Read-only) ====================
class SellerCategoryViewSet(viewsets.ReadOnlyModelViewSet):
    """Seller viewset for categories (read-only)"""
    permission_classes = [IsAuthenticated, IsVendorUser]
...
class SellerSubcategoryViewSet(viewsets.ReadOnlyModelViewSet):
    """Seller viewset for subcategories (read-only)"""
    permission_classes = [IsAuthenticated, IsVendorUser]
...
class SellerColorViewSet(viewsets.ReadOnlyModelViewSet):
    """Seller viewset for colors (read-only)"""
    permission_classes = [IsAuthenticated, IsVendorUser]
    queryset = Color.objects.all().order_by('name')
    serializer_class = AdminColorSerializer


class SellerMaterialViewSet(viewsets.ReadOnlyModelViewSet):
    """Seller viewset for materials (read-only)"""
    permission_classes = [IsAuthenticated, IsVendorUser]
